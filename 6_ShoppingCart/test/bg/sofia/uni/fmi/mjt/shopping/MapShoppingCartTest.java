...
public class MapShoppingCartTest {
    ...
    public void testEmptyDefaultShoppingCart() {
        ShoppingCart cart = new MapShoppingCart();
    ...
    public void testAddNull() {
        ...
        Item chocolate4 = new Chocolate(null, null, CHOCOLATE_COST);

        cart.addItem(chocolate1);
        cart.addItem(chocolate2);
        cart.addItem(chocolate4);
        cart.addItem(null);
    ...
    public void testRemoveFromEmptyCart() throws ItemNotFoundException {
        ...
        assertEquals("Removing an item from an empty shopping cart.",
                cart.getTotal(), NO_ITEMS_COST, PRECISION);
    }
